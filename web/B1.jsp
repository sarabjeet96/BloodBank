<%-- 
    Document   : B1
    Created on : Nov 21, 2019, 10:13:17 AM
    Author     : pc
--%>
...
<body>
    ...
    <div class="p1">
        ...
        <div class="p2">
            ...
            <p>B+ is a rare blood type that holds tremendous power.The most preferred donation method is to donate platelets. 
                Platelets can be donated as often as every seven days and up to 24 times a year. Platelets are in high demand
                by hospitals and often help cancer patients undergoing chemotherapy.</p>
