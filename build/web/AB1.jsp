<%-- 
    Document   : AB1
    Created on : Nov 21, 2019, 10:13:33 AM
    Author     : pc
--%>
...
<body>
    ...
    <div class="p1">
        ...
        <div class="p2">
            ...
            <p>AB+ is one of the rarest of all the blood types. Donors who are AB+ are called the universal plasma donor because 
            this component can be transfused into any patient, regardless of the recipient’s blood type.In addition to your 
            plasma, platelets from AB+ donors are also compatible with several other blood types, making them in high demand by 
            local hospitals.
        </p>
